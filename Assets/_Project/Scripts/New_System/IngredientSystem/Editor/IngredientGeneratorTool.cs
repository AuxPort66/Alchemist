...
public class IngredientGeneratorTool : EditorWindow
{
    ...
    {
        GetWindow<IngredientGeneratorTool>("Ingredient Generator");
    }
    ...
    private void RandomizeSymbolList(Ingredient ingredient)
    {
        ...
        if (!useDefault)
        {
            minMaxStoredRange = IngredientRandomSizeStorage.instance.rangeRandom.GetValueOrDefault(GetGUID(ingredient), minMaxStoredRange);
        }
